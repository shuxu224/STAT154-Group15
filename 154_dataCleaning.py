...
matrix = ve.fit_transform(dictionary)  #matrix without label
...
RF = RandomForestClassifier(n_estimators=300,criterion='entropy',max_features=163,max_depth=5,oob_score=True)
RF.fit(matrix,label)
